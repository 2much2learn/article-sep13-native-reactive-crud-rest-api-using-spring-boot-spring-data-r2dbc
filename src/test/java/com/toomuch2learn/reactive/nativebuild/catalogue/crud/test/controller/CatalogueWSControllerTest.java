package com.toomuch2learn.reactive.nativebuild.catalogue.crud.test.controller;

import com.toomuch2learn.reactive.nativebuild.catalogue.crud.test.CatalogueItemGenerator;
import com.toomuch2learn.reactive.nativebuild.catalogue.crud.SpringReactiveNativeCatalogueCrudApplication;
...
import static com.toomuch2learn.reactive.nativebuild.catalogue.crud.controller.CatalogueControllerAPIPaths.*;
...
@Slf4j
@SpringBootTest(
    classes = SpringReactiveNativeCatalogueCrudApplication.class,
...
public class CatalogueWSControllerTest {
    ...
    public void testCatalogueItemEvent() throws Exception {
         ...
         */
        URI uri = URI.create("ws://localhost:"+port+ GET_ITEMS_WS_EVENTS);
    ...
    private Publisher<CatalogueItemEvent> write(CatalogueItemEvent catalogueItemEvent) {
        ...
        Mono<String> response =
            this.webClient
                .post()
                .uri("http://localhost:"+port+BASE_PATH+CREATE)
